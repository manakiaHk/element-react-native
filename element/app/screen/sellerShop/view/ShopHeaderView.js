    ...
    render() {
        ...
        return (
            <View style={{zIndex:999,alignItems:'center',backgroundColor:'#fff',height:height+photoOverBottom}}>
                {/*背景图*/}
                <Image style={{width:width,height:height}} source={{url:this.props.backgroundImage?this.props.backgroundImage:'https://cube.elemecdn.com/7/c5/9d7f3bf590912ec5a6d562111b40dpng.png'}}/>
                {/*背景图遮罩层*/}
                ...
                <Image style={{position:'absolute',borderRadius:5,left:width/2-photoWidth/2,bottom:1,height:photoWidth,width:photoWidth}}
                       source={{url:this.props.image?this.props.image:'https://cube.elemecdn.com/6/2e/d9d29554f6ed8d1ac93c6a8358e98png.png'}}
                />
            </View>
        );
    }
